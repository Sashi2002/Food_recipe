...
const Semi = () => {
  return (
    <div className="flex ">
      <Link href="">
        <div className="flex items-center justify-center w-64 h-64 duration-500 bg-[#EFEA5A] rounded-lg hover:items-start hover:pt-10 hover:h-96 hover:w-72">
          <div className="relative inline-block transition duration-500 ease-in-out group delay-10 hover:-translate-y-3 hover:scale-110">
            <div className="h-60 w-60">
              <img src="/images/gg.jpg" className="w-full h-full" alt="" />
            </div>
